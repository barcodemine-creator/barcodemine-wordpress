<?php
/**
 * Fix Syntax Error in Telegram Blog Publisher Plugin
 * This will restore the plugin to working condition
 */
...
// Create a clean, working version of the plugin
$clean_plugin_content = '<?php
/**
...
// Write the clean plugin file
if (file_put_contents($plugin_file, $clean_plugin_content)) {
    echo "✅ Plugin file fixed and restored\n";
} else {
    echo "❌ Failed to fix plugin file\n";
    exit;
}
...
echo "\n🎉 SYNTAX ERROR FIXED!\n";
echo "======================\n";
echo "✅ Plugin restored to working condition\n";
echo "✅ All syntax errors resolved\n";
echo "✅ Gemini API updated with latest models\n";
