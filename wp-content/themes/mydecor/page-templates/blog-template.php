...
$page_column_class = mydecor_page_layout_columns_class($page_options['ts_page_layout']);
...
if( $show_breadcrumb || $show_page_title ){
	$extra_class = 'show_breadcrumb_'.mydecor_get_theme_options('ts_breadcrumb_layout');
}
