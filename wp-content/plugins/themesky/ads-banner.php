<?php
add_action('redux/page/mydecor_theme_options/form/before', 'ts_ads_banner_html');
add_action('redux/page/mydecor_theme_options/form/after', 'ts_ads_banner_html');
if( !function_exists('ts_ads_banner_html') ){
	function ts_ads_banner_html(){
		if( isset($_COOKIE['ts_theme_ads_banner']) ){
			return;
		}
		$theme_url = 'https://1.envato.market/joo6M';
		?>
