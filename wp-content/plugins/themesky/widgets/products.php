...
if( !class_exists('TS_Products_Widget') ){
	class TS_Products_Widget extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			$lazy_load = !wp_doing_ajax() && function_exists('mydecor_get_theme_options')?mydecor_get_theme_options('ts_prod_lazy_load'):false;
			$placeholder_img_src = $lazy_load && function_exists('mydecor_get_theme_options')?mydecor_get_theme_options('ts_prod_placeholder_img')['url']:'';
						...
						<?php endif; ?>
							<li>
								...
								<div class="ts-wg-meta">
									<?php
									if( $show_categories && function_exists('mydecor_template_loop_categories') ){ 
										mydecor_template_loop_categories(); 
									}
									?>
