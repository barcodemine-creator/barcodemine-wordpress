<?php
$options = array();
$default_sidebars = function_exists('mydecor_get_list_sidebars')? mydecor_get_list_sidebars(): array();
...
$footer_blocks = function_exists('mydecor_get_footer_block_options')? mydecor_get_footer_block_options(): array();
