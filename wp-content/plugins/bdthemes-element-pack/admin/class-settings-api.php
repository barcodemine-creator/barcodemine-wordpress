		...
		function callback_text( $args ) {
			...
			<div class="ep-option-item-inner">
				...
				<input type="<?php echo esc_attr( $type ); ?>" class="<?php echo esc_attr( $class ); ?>"
					id="<?php echo esc_attr( $args['section'] ); ?>" name="<?php echo esc_attr( $args['id'] ); ?>"
										...
										<?php if ( $form['id'] == 'element_pack_active_modules' or $form['id'] == 'element_pack_third_party_widget' ) : ?>
											...
											<div>
												...
												<div bdt-dropdown="animation: bdt-animation-slide-top-small; duration: 300">
													<ul
														class="bdt-nav bdt-subnav-pill bdt-dropdown-nav ep-widget-filter ep-widget-content-type">
							...
							<div class="element-pack-footer-info bdt-container-xlarge">
								...
								<div class="bdt-grid ">
									...
									<div class="bdt-width-expand@s bdt-text-right">
										<p class="">
											Element Pack Pro plugin made with love by <a target="_blank"
